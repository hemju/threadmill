...
final class SoakHarnessSmokeTest {
  ...
  @Test
  void smokeRunOnMemoryProducesPassedVerdictAndAllArtifacts(@TempDir Path tempDir)
      throws Exception {
    ...
    try {
      ...
      JsonNode progress =
          progressMapper.readTree(Files.readString(outputDir.resolve("progress.json")));
