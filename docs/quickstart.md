...
```kotlin
implementation("com.hemju.threadmill:threadmill-spring-boot:0.1.2")
implementation("com.hemju.threadmill:threadmill-store-postgres:0.1.2")
// or: implementation("com.hemju.threadmill:threadmill-store-redis:0.1.2")
```
