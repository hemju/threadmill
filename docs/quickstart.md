...
```kotlin
implementation("com.hemju.threadmill:threadmill-spring-boot:0.2.0")
implementation("com.hemju.threadmill:threadmill-store-postgres:0.2.0")
// or: implementation("com.hemju.threadmill:threadmill-store-redis:0.2.0")
```
