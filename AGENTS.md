...
| Single-row per-state counters convoy every concurrent Postgres writer (13 jobs/s under 16 producers) | `PostgresJobStoreRegressionTest` migration-count assertions pin V2; the load regression is the soak stress shape (`-Pproducers=16`) |
